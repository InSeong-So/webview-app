...
export const PADDING_BOTTOM = ScreenUtils.getPaddingBottomByDevice();
export const PADDING_TOP = ScreenUtils.getPaddingTopByDevice();
...
export const TOP_HEIGHT = Platform.select({
  ios: configs.heightHeader + ScreenUtils.getPaddingTopByDevice(),
